...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Bakers Bros | Artisan Cafe & Bakery" },
      { property: "og:description", content: "Freshly baked artisan breads, pastries & specialty coffee in Saguramo. Visit us or call for custom orders." },
