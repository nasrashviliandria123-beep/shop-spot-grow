...
const menuSections = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        image: lobiani.url,
        sizes: [
          { ka: "პატარა", en: "S", price: "15.50 ₾", priceNum: 15.5 },
          { ka: "საშუალო", en: "M", price: "17.50 ₾", priceNum: 17.5 },
          { ka: "დიდი", en: "L", price: "23.50 ₾", priceNum: 23.5 },
        ],
      },
      {
        ka: "აჭარული ლობიანი",
      ...
      },
      {
        ...
        image: achma.url,
        sizes: [
          { ka: "პატარა", en: "S", price: "6.50 ₾", priceNum: 6.5 },
