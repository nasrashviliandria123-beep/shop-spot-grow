...
const menuSections = [
  {
    ...
    wide: true,
    items: [
      { ka: "იმერული ხაჭაპური (პატარა)", en: "Imeretian Khachapuri (small)", price: "12 ₾", priceNum: 12 },
      { ka: "იმერული ხაჭაპური (საშუალო)", en: "Imeretian Khachapuri (medium)", price: "14 ₾", priceNum: 14 },
      { ka: "იმერული ხაჭაპური (დიდი)", en: "Imeretian Khachapuri (large)", price: "17 ₾", priceNum: 17 },
      { ka: "მეგრული ხაჭაპური (საშუალო)", en: "Megrelian Khachapuri (M)", price: "16 ₾", priceNum: 16 },
      { ka: "ლაზური ხაჭაპური (საშუალო)", en: "Lazian Khachapuri (M)", price: "20 ₾", priceNum: 20 },
      { ka: "აჭარული ხაჭაპური (პატარა)", en: "Adjaran Khachapuri (S)", price: "14.50 ₾", priceNum: 14.5 },
      { ka: "ლობიანი (საშუალო)", en: "Lobiani (M)", price: "10 ₾", priceNum: 10 },
      { ka: "აჭარული ლობიანი", en: "Adjaran Lobiani", price: "12 ₾", priceNum: 12 },
  ...
  },
  {
    ...
    items: [
      { ka: "პიცა მარგარიტა", en: "Margherita", price: "19 ₾", priceNum: 19, image: margherita.url },
      { ka: "პიცა შამპინიონი", en: "Mushroom", price: "22 ₾", priceNum: 22, image: mushroom.url },
